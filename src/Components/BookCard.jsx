...
const BookCard = ({book}) => {
    ...
    const {bookName, author, image,rating,  category, id} = book;
    ...
    return (
        ...
        <div className="card-body px-0">
          <div >
            <button className="text-[#23BE0A] bg-[#23BE0A0D] font-medium px-4 py-2 rounded-full ">Young Adult</button>
            <button className="text-[#23BE0A] bg-[#23BE0A0D] font-medium px-4 py-2 ml-3 rounded-full ">Identity</button>
          </div>
